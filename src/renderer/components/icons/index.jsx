 ...
 * All icons follow a consistent interface: ({ className }) => JSX
 *
...
FolderOpenIcon.propTypes = { className: PropTypes.string };
...
AlertTriangleIcon.propTypes = { className: PropTypes.string };
...
BarChart3Icon.propTypes = { className: PropTypes.string };

/**
 * Check circle icon - represents success/completion
 */
export function CheckCircle2Icon({ className }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        strokeLinecap="round"
...
CheckCircle2Icon.propTypes = { className: PropTypes.string };
...
InboxIcon.propTypes = { className: PropTypes.string };
...
FileStackIcon.propTypes = { className: PropTypes.string };
