...
class FileSystemError extends Error {
  ...
  generateMessage() {
    const messages = {
      ...
      [FILE_SYSTEM_ERROR_CODES.TOO_MANY_OPEN_FILES]: 'Too many open files - system resource limit reached',
  ...
  getUserFriendlyMessage() {
    const userMessages = {
      [FILE_SYSTEM_ERROR_CODES.FILE_ACCESS_DENIED]: 'Cannot access this file. It may be protected or you may not have permission.',
      [FILE_SYSTEM_ERROR_CODES.FILE_NOT_FOUND]: 'The file could not be found. It may have been moved or deleted.',
      [FILE_SYSTEM_ERROR_CODES.DIRECTORY_NOT_FOUND]: 'The folder could not be found. It may have been moved or deleted.',
      [FILE_SYSTEM_ERROR_CODES.PERMISSION_DENIED]: 'You do not have permission to perform this action. Try running as administrator.',
      [FILE_SYSTEM_ERROR_CODES.WRITE_FAILED]: 'Failed to save the file. Please check that the location is writable.',
      [FILE_SYSTEM_ERROR_CODES.READ_FAILED]: 'Failed to read the file. It may be corrupted or inaccessible.',
      [FILE_SYSTEM_ERROR_CODES.DELETE_FAILED]: 'Failed to delete. The file may be in use by another program.',
      [FILE_SYSTEM_ERROR_CODES.RENAME_FAILED]: 'Failed to rename. The destination may already exist or be inaccessible.',
      [FILE_SYSTEM_ERROR_CODES.COPY_FAILED]: 'Failed to copy the file. Check available disk space and permissions.',
      [FILE_SYSTEM_ERROR_CODES.MOVE_FAILED]: 'Failed to move the file. The destination may be unavailable.',
      [FILE_SYSTEM_ERROR_CODES.MKDIR_FAILED]: 'Failed to create the folder. Check permissions and available space.',
      [FILE_SYSTEM_ERROR_CODES.RMDIR_FAILED]: 'Failed to remove the folder. It may contain files or be in use.',
      [FILE_SYSTEM_ERROR_CODES.DIRECTORY_NOT_EMPTY]: 'The folder is not empty. Remove its contents first.',
      ...
      [FILE_SYSTEM_ERROR_CODES.DISK_FULL]: 'Your disk is full. Please free up some space and try again.',
      [FILE_SYSTEM_ERROR_CODES.QUOTA_EXCEEDED]: 'Your storage quota has been exceeded.',
      [FILE_SYSTEM_ERROR_CODES.TOO_MANY_OPEN_FILES]: 'Too many files are open. Close some applications and try again.',
      [FILE_SYSTEM_ERROR_CODES.FILE_IN_USE]: 'The file is being used by another program. Close it and try again.',
      [FILE_SYSTEM_ERROR_CODES.FILE_LOCKED]: 'The file is locked. Close any programs using it.',
      [FILE_SYSTEM_ERROR_CODES.FILE_EXISTS]: 'A file with this name already exists in the destination.',
      [FILE_SYSTEM_ERROR_CODES.FILE_TOO_LARGE]: 'The file is too large to process.',
      [FILE_SYSTEM_ERROR_CODES.PATH_TOO_LONG]: 'The file path is too long. Try a shorter filename or folder path.',
      [FILE_SYSTEM_ERROR_CODES.INVALID_PATH]: 'The file path contains invalid characters.',
      [FILE_SYSTEM_ERROR_CODES.CROSS_DEVICE_LINK]: 'Cannot move files directly between different drives.',
      [FILE_SYSTEM_ERROR_CODES.CHECKSUM_MISMATCH]: 'File verification failed. The file may be corrupted.',
      [FILE_SYSTEM_ERROR_CODES.SIZE_MISMATCH]: 'File size verification failed. The copy may be incomplete.',
      [FILE_SYSTEM_ERROR_CODES.PARTIAL_WRITE]: 'Only part of the file was written. Please try again.',
      [FILE_SYSTEM_ERROR_CODES.CORRUPTED_FILE]: 'The file appears to be corrupted and cannot be processed.',
      ...
      [FILE_SYSTEM_ERROR_CODES.ATOMIC_OPERATION_FAILED]: 'The file operation could not be completed safely.',
      [FILE_SYSTEM_ERROR_CODES.ROLLBACK_FAILED]: 'Failed to undo the file operation. Some files may need manual recovery.',
      [FILE_SYSTEM_ERROR_CODES.TRANSACTION_TIMEOUT]: 'The operation took too long and was cancelled.',
      [FILE_SYSTEM_ERROR_CODES.IO_ERROR]: 'A hardware or disk error occurred. Check your disk health.',
      [FILE_SYSTEM_ERROR_CODES.NETWORK_ERROR]: 'Cannot access the network location. Check your connection.',
  ...
  static forOperation(operation, nodeError, filePath) {
    ...
    const code = NODE_ERROR_CODE_MAP[nodeError?.code] ||
